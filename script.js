    ...
    players.forEach((plr, index) => {
        ...
        if (plr.position == "GK") {
            ...
            <div class="flex space-x-2 justify-center mt-4">
                <button class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600" onclick="editPlayer(${index})">
                    Modifier
                </button>
                <button class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600" onclick="deletePlayer(${index})">
                    Supprimer
                </button>
            </div>
        `;
